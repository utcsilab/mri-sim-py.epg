...
def FSE_signal_TR_ex(angle_ex_rad, angles_rad, TE, TR, T1, T2, B1=1.0):
    """Same as FSE_signal2_TR_ex, but only returns Mxy"""
    return FSE_signal2_TR_ex(angle_ex_rad, angles_rad, TE, TR, T1, T2, B1)[0]


def FSE_signal_TR(angles_rad, TE, TR, T1, T2, B1=1.0):
    """Same as FSE_signal2_TR, but only returns Mxy"""
    return FSE_signal2_TR(angles_rad, TE, TR, T1, T2, B1)


def FSE_signal2_TR(angles_rad, TE, TR, T1, T2, B1=1.0):
    """Same as FSE_signal2, but includes finite TR"""
    pi = torch.tensor(np.pi, device=T2.device)
    return FSE_signal2_TRs_ex(pi / 2, angles_rad, TE, TR, T1, T2, 1.0)


def FSE_signal2_TR_ex(angle_ex_rad, angles_rad, TE, TR, T1, T2, B1=1.0):
...
def FSE_signal_ex(angle_ex_rad, angles_rad, TE, T1, T2, B1=1.0):
